...
```text
1. 目标力稳定时的抖动范围：约 ±___ N
2. 典型松手下降幅度：约 ___ N
3. 典型松手下降持续时间：约 ___ s
4. 希望下降开始后多久张开：约 ___ ms
5. 高抓握力调小但不松手时，目标力最低会调到多少：___ N
6. 真正希望张开时，目标力一般会低于多少：___ N
7. 下降过程中典型反弹幅度：约 ___ N
```
...
```text
1. 实测力稳定时噪声范围：约 ±___ N
2. 低力区实测力噪声范围：约 ±___ N
3. 目标力下降后，实测力滞后多久才下降到低力区：约 ___ s
4. 真正松手时，实测力一般低于多少：___ N
5. 调小抓握力但不松手时，实测力最低可能到多少：___ N
```
...
```text
1. 夹爪从典型抓握宽度张开到 start_width_mm 需要多久：约 ___ s
2. width_mm 反馈是否稳定可靠
3. 到达 start_width_mm 附近时的宽度误差：约 ___ mm
4. 可以接受的张开完成容差：___ mm
```
